                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
                    {agents.map((agent, index) => (
                        <motion.div
                            ...
                            className="p-8 rounded-3xl bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 shadow-sm hover:shadow-xl transition-all relative overflow-hidden group"
                        >
                            ...
                            <ul className="space-y-4 relative">
                                {agent.tasks.map((task, i) => (
                                    <li key={i} className="flex items-start gap-3 text-slate-600 dark:text-slate-400">
                                        <div className={`mt-1.5 w-1.5 h-1.5 rounded-full bg-slate-400 dark:bg-slate-500`} />
