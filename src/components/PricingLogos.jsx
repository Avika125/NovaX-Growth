            ...
            <div className="container mx-auto px-6">
                <div className="text-center mb-12">
                    ...
                    <motion.h2
                        ...
                        viewport={{ once: true }}
                        className="text-4xl md:text-6xl font-['Playfair_Display'] font-medium text-slate-900 dark:text-white"
                    >
                    ...
                    {logos.map((logo, index) => (
                        ...
                        >
                            <span className="text-lg font-bold tracking-tighter text-slate-900 dark:text-white">
                                {logo === "THE PAAK" ? (
                                    <span className="border-2 border-slate-900 dark:border-white px-2 py-0.5">THE PAAK</span>
                                ) : (
                                    <span>{logo}</span>
                                )}
                            </span>
