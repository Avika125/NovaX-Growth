                ...
                <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24 max-w-6xl mx-auto">
                    <div className="lg:w-1/2">
                        <motion.h2
                            ...
                            viewport={{ once: true }}
                            className="text-5xl md:text-7xl font-['Playfair_Display'] font-medium text-slate-900 dark:text-white leading-[1.1] mb-16"
                        >
                            Metrics that <br />
                            power growth
                        </motion.h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-16">
                            {metrics.map((metric, index) => (
                                ...
                                >
                                    <span className={`font-['Playfair_Display'] font-medium text-slate-900 dark:text-white block ${index === 0 ? 'text-7xl md:text-8xl mb-2' : 'text-5xl md:text-6xl mb-1'}`}>
                                        {metric.value}
                                    </span>
                                    <p className="text-[10px] text-slate-500 dark:text-zinc-500 uppercase tracking-widest font-bold">
                                        {metric.label}
                                    </p>
                                </motion.div>
                            ))}
                    ...
                    <div className="lg:w-1/2">
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="aspect-[4/3] rounded-[40px] overflow-hidden shadow-2xl ring-1 ring-slate-200/50 dark:ring-white/5"
                        >
                            <img
