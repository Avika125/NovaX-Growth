    ...
    return (
        <section className="py-24 bg-slate-50 dark:bg-black transition-colors duration-300 overflow-hidden">
            <div className="container mx-auto px-6 relative">
                <div className="max-w-4xl mx-auto rounded-[3rem] bg-slate-900 dark:bg-white/5 border border-slate-800 dark:border-white/10 p-12 md:p-20 relative">
                    ...
                    <div className="relative z-10 text-center">
                        ...
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="inline-block p-6 rounded-2xl bg-white/5 border border-white/10 text-xl md:text-2xl font-bold text-slate-400 dark:text-slate-300 italic"
                        >
