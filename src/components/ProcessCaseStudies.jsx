            ...
            <div className="container mx-auto px-6">
                <div className="text-center mb-16">
                    <motion.h2
                        ...
                        viewport={{ once: true }}
                        className="text-5xl md:text-7xl font-['Playfair_Display'] font-medium text-slate-900 dark:text-dark-100 leading-[1.1]"
                    >
                        Automation that <br />
                        closes more deals
                    </motion.h2>
                ...
                <div className="max-w-4xl mx-auto border border-slate-100 dark:border-dark-700 rounded-3xl overflow-hidden shadow-2xl bg-white dark:bg-dark-800/50">
                    <div className="flex border-b border-slate-100 dark:border-dark-700 bg-slate-50 dark:bg-dark-800/50">
                        {studies.map((study, index) => (
                            ...
                            >
                                <div className="w-8 h-8 rounded-full overflow-hidden bg-slate-200 dark:bg-dark-700">
                                    <img src={study.image} alt="" className="w-full h-full object-cover" />
                                </div>
                                <span className="text-[10px] font-bold tracking-widest text-slate-900 dark:text-dark-100 uppercase">{study.logo}</span>
                                {activeTab === index && (
                                    <motion.div
                        ...
                        <AnimatePresence mode="wait">
                            ...
                            >
                                <div className="md:w-1/2 space-y-8">
                                    <p className="text-xl md:text-2xl font-['Playfair_Display'] text-slate-900 dark:text-dark-100 leading-relaxed italic">
                                        "{studies[activeTab].quote}"
                                    </p>
                                    <div>
                                        <h4 className="text-sm font-bold text-slate-900 dark:text-dark-100 mb-1">
                                            {studies[activeTab].author}
                                        </h4>
                                        <p className="text-[11px] text-slate-400 dark:text-dark-600 uppercase tracking-widest font-bold">
