                ...
                <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 max-w-6xl mx-auto">
                    <div className="lg:w-1/2">
                        <motion.span
                            ...
                            viewport={{ once: true }}
                            className="text-[10px] font-bold text-slate-400 dark:text-dark-600 uppercase tracking-[0.4em] block mb-6"
                        >
                            FAQ
                        </motion.span>
                        <motion.h2
                        ...
                        <motion.p
                            ...
                            className="text-slate-500 dark:text-dark-200 text-[13px] leading-relaxed mb-12 max-w-md"
                        >
                    ...
                    <div className="lg:w-1/2 space-y-4">
                        {faqs.map((faq, index) => (
                            <motion.div
                                ...
                                className="bg-[#FDFCF9] dark:bg-dark-800 border border-slate-100 dark:border-dark-700 rounded-2xl overflow-hidden"
                            >
                                <button
                                ...
                                >
                                    ...
                                    <span className={`text-slate-400 dark:text-dark-200 transition-transform duration-300 ${activeIndex === index ? 'rotate-180' : ''}`}>
                                ...
                                <AnimatePresence>
                                    {activeIndex === index && (
                                        ...
                                        >
                                            <div className="px-8 pb-5 text-xs text-slate-500 dark:text-dark-200 leading-relaxed border-t border-slate-100/50 dark:border-dark-700 pt-3">
                                                {faq.answer}
                                            </div>
                                        </motion.div>
                                    )}
