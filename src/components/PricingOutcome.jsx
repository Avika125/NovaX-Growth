            ...
            <div className="container mx-auto px-6">
                <div className="text-center mb-16">
                    ...
                    <motion.p
                        ...
                        className="text-slate-500 dark:text-slate-400 text-[11px] max-w-2xl mx-auto leading-relaxed mb-10"
                    >
                ...
                <motion.div
                    ...
                    className="aspect-[16/8] md:aspect-[21/9] rounded-[40px] overflow-hidden shadow-2xl ring-1 ring-slate-200/50 dark:ring-white/5"
                >
                    <img
